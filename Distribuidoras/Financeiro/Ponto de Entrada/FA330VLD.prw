...
ฑฑบPrograma  ณFA330VLD   บAutor  ณ Andr้ Salgado      บ Data ณ  17/01/2021บฑฑ
...
For Z   := 1 to Len(Atitulos) 
    ...
    //Chamado - TK2203360  - Autor Andr้ 01/04/2022
    //Grava os Dados da Cobran็a do Titulo - Solic. Jacq / Alessandra
