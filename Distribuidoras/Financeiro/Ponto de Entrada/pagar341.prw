    ...
    Case _cTipo == "PT001"	                           
         ...
         If SEA->EA_MODELO == "16"    
           ...
           // _cRetorno := "02"                         
            ...
            _cRetorno += If(!Empty(SE2->E2_XDARF02),STRZERO(Val(SE2->E2_XDARF02),4),STRZERO(Val(SE2->E2_CODRET),4))
  
            // Posicao 024 a 024: Tp Inscricao  1-CPF /  2-CNPJ               
           If !Empty(SE2->E2_XCNPJ)
               _cRetorno += Iif (len(alltrim(SE2->E2_XCNPJ))>11,"2","1")
           Else               
              _cRetorno += "2"       
           EndIf
            ...
            If !Empty(SE2->E2_XCNPJ)
               _cRetorno += Strzero(Val(SE2->E2_XCNPJ),14)
            Else
               _cRetorno += Subs(SM0->M0_CGC,1,14)
            EndIf
                                                 
            // Posicao 039 a 046: Periodo Apuracao
            _cRetorno += GravaData(SE2->E2_X_APURA,.F.,5) 
         ...
         ElseIf (SEA->EA_MODELO == "17")   
            ...
            _cRetorno +=  STRZERO(Val(SE2->E2_XDARF02),4)  
                                                 
            // Posicao 024 a 029: Competencia   MMAAAA  
            _cRetorno += STRZERO(MONTH(SE2->E2_X_APURA),2)+STRZERO(YEAR(SE2->E2_X_APURA),4)
