...
Static Function MainDevApp(lInit)
	...
	Local aEmpExQr  := {}
	Local aFolder   := {'Query', 'Dicionário', 'Inspeção de Funções/Comandos', 'Linha de Comando','Html', 'File Explorer','Conversor Base64'}
	...
	DEFINE MSDIALOG oDlg FROM 0,0 TO 0,0 TITLE  "Ferramenta de desenvolvimento"
        ...
        //--Folder Base64 Converter
        FolderB64(oFol:aDialogs[7], oSize)
